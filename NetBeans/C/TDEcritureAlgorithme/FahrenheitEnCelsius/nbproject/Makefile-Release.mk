...
# Object Files
OBJECTFILES= \
	${OBJECTDIR}/Fahrenheit\ en\ Celsius.o
...
.NO_PARALLEL:${OBJECTDIR}/Fahrenheit\ en\ Celsius.o
${OBJECTDIR}/Fahrenheit\ en\ Celsius.o: Fahrenheit\ en\ Celsius.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Fahrenheit\ en\ Celsius.o Fahrenheit\ en\ Celsius.c
